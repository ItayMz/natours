...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaXRheS1tYXBib3giLCJhIjoiY2xtN3B2OTBhMDRvdTNkcjd3MWZ0aTVmeiJ9.I4MjeM6mYi1GZD8QXf1OTA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/itay-mapbox/clrp5o5sa008v01pe87hth18r',
    // style URL
    scrollZoom: false
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51OcXkJHgi1prQc23qqNSMvw4jQAtDFtAAn4zGvwkHW9BgkDZpmPvEBotYcwcjTS4sLitx9K3tYO3UhENtx8psE3h00QXfoBUxV');
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
function leaveReview(_x, _x2, _x3, _x4) {
  return _leaveReview.apply(this, arguments);
}
function _leaveReview() {
  _leaveReview = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, rating, tour, user) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Review was successfully uploaded.');
            setTimeout(function () {
...
function deleteReview(_x5) {
  return _deleteReview.apply(this, arguments);
}
function _deleteReview() {
  _deleteReview = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(reviewId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Review was successfully deleted.');
            setTimeout(function () {
              location.reload(true);
            }, 1000);
          }
...
function updateReview(_x6, _x7) {
  return _updateReview.apply(this, arguments);
}
function _updateReview() {
  _updateReview = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(reviewId, formData) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Review was successfully updated.');
            setTimeout(function () {
              location.reload(true);
            }, 1000);
          }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
function likeTour(_x) {
  return _likeTour.apply(this, arguments);
}
function _likeTour() {
  _likeTour = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://localhost:3000/api/v1/tours/".concat(tourId, "/like-current-tour")
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Successfully liked the tour');
            window.setTimeout(function () {
              location.reload(true);
            }, 500);
          }
...
function unlikeTour(_x2) {
  return _unlikeTour.apply(this, arguments);
}
function _unlikeTour() {
  _unlikeTour = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tourId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://localhost:3000/api/v1/tours/".concat(tourId, "/unlike-current-tour")
          });
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Successfully unliked the tour');
            window.setTimeout(function () {
              location.reload(true);
            }, 500);
          }
...
var likeTourBtn = document.getElementById('like-button');
var unlikeTourBtn = document.getElementById('unlike-button');
var saveButtons = document.querySelectorAll('.update-submit-button');
...
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    ...
    var reviewRating = document.getElementById('rating').value;
    var _JSON$parse = JSON.parse(reviewForm.dataset.ids),
      user = _JSON$parse.user,
      tour = _JSON$parse.tour;
    (0, _reviews.leaveReview)(reviewText, reviewRating, tour, user);
...
if (unlikeTourBtn) {
  unlikeTourBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var tourId = e.target.dataset.tourId;
    (0, _likeTour.unlikeTour)(tourId);
  });
}

// For triggering the "view review form" and deleting review
document.addEventListener('DOMContentLoaded', function () {
  var reviewsContainer = document.querySelector('.user-reviews');
  reviewsContainer.addEventListener('click', function (event) {
    ...
    if (event.target.classList.contains('update-button')) {
      var review = JSON.parse(event.target.dataset.review);
      var reviewId = review.id;
      var reviewCard = event.target.closest('.user-review-card');
      var _reviewForm = reviewCard.nextElementSibling;
      var reviewTextArea = _reviewForm.querySelector('textarea'); // Get the textarea element
      ...
      _reviewForm.classList.remove('hidden');
    } else if (event.target.classList.contains('delete-button')) {
      var _reviewId = event.target.dataset.reviewId;
      (0, _reviews.deleteReview)(_reviewId);
    }

    // Handle click event on the "Cancel" button
    if (event.target.classList.contains('cancel-edit-button')) {
      var _reviewForm2 = event.target.closest('.user-review-form');
      var _reviewCard = _reviewForm2.previousElementSibling;

      // Hide the form and show the review card
      _reviewForm2.classList.add('hidden');
      _reviewCard.classList.remove('hidden');
    }
  });
});
